...
function Header() {
  ...
  const { linkdein, github, instagram, cv } = socialMediaUrl;
  const toggleClass = () => {
    setIsOpen(!isOpen);
  };
    ...
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
        ...
        <div onClick={toggleClass} className="cursor-pointer">
          <svg className="stroke-dark-heading dark:stroke-white md:hidden" width="25" height="20" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          ...
          <li >
            <a style={{ display: "flex", alignItems: "center", gap: "10px" }} href={cv} target="_blank" rel="noreferrer noopener">
              <img width={30} src={DW} />
